								...
								<div class="card-body row">
									<div class="col-lg-9">
										<div class="mb-3">
											...
											<input type="text" name="service_name" {{$readonly}} id="service_name" onkeyup="isi_target(this.value)" onkeypress="return hanyaAngka(event)"  value="{{$data->service_name}}" class="form-control" id="project-title-input" placeholder="Enter...">
										</div>
									</div>
									<div class="col-lg-5">
										<div class="mb-3">
...
<div id="modal-schema" class="modal fade flip " tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">                                               <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="myModalLabel">Schema</h5>
