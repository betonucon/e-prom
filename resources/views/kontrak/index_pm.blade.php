    ...
    <script type="text/javascript">
        ...
        */
        function load_data(){
			$.ajax({ 
                type: 'GET', 
                url: "{{ url('project/getdatadashboardpm')}}", 
                data: { ide: 1 }, 
                dataType: 'json',
                beforeSend: function() {
                    $('#project').val(0)
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0" style="text-transform:uppercase" >Management Pekerjaan</h4>
