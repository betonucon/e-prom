		...
		<form  id="mydata" method="post" action="{{ url('kontrak/publish') }}" enctype="multipart/form-data" >
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row mt-2">
						<div class="col-lg-12">
							<span  class="btn btn-success btn-label waves-effect waves-light" id="save-data"><i class="ri-check-double-line label-icon align-middle fs-16 me-2"></i> Publish Kontrak</span>
						</div>
