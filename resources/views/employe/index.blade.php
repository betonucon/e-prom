                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0" style="text-transform:uppercase" >Employe</h4>

                            <div class="page-title-right">
                            <span onclick="tambah(0)" class="btn btn-success btn-sm waves-effect waves-light "><i class="mdi mdi-plus-circle-outline"></i> New Employe</span>
                            </div>
...
@push('ajax')
        ...
        <script type="text/javascript">
			...
			function tambah(id){
				...
				$('#tampil-form').load("{{url('employe/modal')}}?id="+id)
			} 
